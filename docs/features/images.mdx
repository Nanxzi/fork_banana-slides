...
Enable **Quality Control** from **Settings → Image Generation Configuration** or from the Slide Preview page, where the switch sits below the "Generate All Images" button on wide screens and moves into the bottom toolbar on narrow ones.
